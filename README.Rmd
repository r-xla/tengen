...
tengen provides an S3 class hierarchy for representing tensor data types via `TensorDataType`:
...
* `as_dtype(x)`: Convert a string (e.g. `"f32"`) or `TensorDataType` to a `TensorDataType` object.
